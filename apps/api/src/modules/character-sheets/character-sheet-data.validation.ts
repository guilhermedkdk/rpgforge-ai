...
import { persistedCharacterDataSchema, type PersistedCharacterData } from '@rpgforce-ai/shared';

/**
 * Validates the persisted sheet `data` JSON against the shared schema (v1).
 */
export function validateCharacterSheetData(data: Record<string, unknown>): PersistedCharacterData {
