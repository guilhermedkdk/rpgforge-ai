...
/**
 * Spellbook capacity learned through level progression. Scroll spells and the free Evocation
 * Savant spells enter the spellbook without consuming this capacity (their own buckets).
 */
